...
class PopupWindow:
    ...
    def show(self) -> None:
        ...
        emotion_font = tkfont.Font(family="Yu Gothic UI", size=10, weight="bold")
        ...
        for emotion in EMOTION_LABELS:
            ...
            btn = tk.Button(
                self.emotion_frame, text=emotion, font=emotion_font,
    ...
    def _on_emotion_tapped(self, emotion: str) -> None:
        ...
        if ok:
            self.emotion_feedback_label.config(
                text=f"{emotion} を記録しました（{stamp.strftime('%H:%M')}）"
            )
        else:
