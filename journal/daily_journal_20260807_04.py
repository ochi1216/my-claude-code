...
class PopupWindow:
    ...
    def show(self) -> None:
        ...
        # 指定するだけでは揃わなかった（📊のグリフ自体が✅❌より小さく
        # 描画される）ため、DBだけ別フォントでポイントサイズを大きくして
        # 見た目の大きさを合わせている
        icon_btn_font = tkfont.Font(family="Yu Gothic UI", size=14)
        dashboard_icon_font = tkfont.Font(family="Yu Gothic UI", size=20)
