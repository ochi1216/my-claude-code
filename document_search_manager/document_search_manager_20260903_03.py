...
# -*- coding: utf-8 -*-
"""
Document Search Manager  v20260903_03
=====================================
...
<header>
  ...
  <div class="sub">社内ドキュメント横断検索 &nbsp;/&nbsp; v20260903_03 (Phase 1: SharePoint)</div>
</header>
...
def main() -> None:
    ...
    print("=" * 70)
    print("📚 Document Search Manager  v20260903_03  (Phase 1: SharePoint)")
    print("=" * 70)
