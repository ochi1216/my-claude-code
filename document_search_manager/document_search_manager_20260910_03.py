...
# -*- coding: utf-8 -*-
"""
Document Search Manager  v20260910_03
=====================================
...
<header>
  ...
  <div class="sub">社内ドキュメント横断検索 &nbsp;/&nbsp; v20260910_03 (図面PDFの判定)</div>
</header>
...
def main() -> None:
    ...
    print("=" * 70)
    print("📚 Document Search Manager  v20260910_03  (図面PDFの判定)")
    print("=" * 70)
