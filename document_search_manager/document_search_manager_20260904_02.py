...
# -*- coding: utf-8 -*-
"""
Document Search Manager  v20260904_02
=====================================
...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .summary-insight { margin-bottom: 12px; }
  .summary-insight-label { font-weight: 600; margin-bottom: 2px; }
...
<header>
  ...
  <div class="sub">社内ドキュメント横断検索 &nbsp;/&nbsp; v20260904_02 (要約機能 Phase A)</div>
</header>
...
function renderSummaryBody(box, data) {
  ...
  [["活用すべきこと", insights.use],
   ["考慮すべき注意点", insights.caution],
   ["さらに問いを深めるべき方向性", insights.questions]].forEach(function (pair) {
...
SUMMARY_RESPONSE_SCHEMA = {
    ...
    "properties": {
        ...
        "insights": {
            ...
            "properties": {
                "use": {"type": "STRING", "description": "活用すべきこと"},
                "caution": {"type": "STRING", "description": "考慮すべき注意点"},
                "questions": {"type": "STRING", "description": "さらに問いを深めるべき方向性"},
            },
...
SUMMARY_PROMPT_TEMPLATE = """あなたは半導体メーカー(Nexperia)の社内文書を分析する専門アシスタントです。
以下は文書「{title}」の本文です（長い場合は先頭部分のみの可能性があります）。

この文書の内容を分析し、指定されたJSON形式で、必ず日本語で出力してください。
文書が英語や他の言語であっても、必ず日本語に翻訳した上で要約してください。

- executive_summary: この文書が何についてのものかを300字程度で簡潔に説明する。
- chapters: 文書の構造（章立てや話題のまとまり）ごとに、章タイトルと概要をリストにする。
- insights: 半導体メーカーの日本拠点責任者（Japan Site Manager）が、この文書を
  もとに業務を遂行する上での羅針盤となる示唆を3点。
  - use: 活用すべきこと
  - caution: 考慮すべき注意点
  - questions: さらに"問い"を深めるべき方向性
...
def main() -> None:
    ...
    print("=" * 70)
    print("📚 Document Search Manager  v20260904_02  (要約機能 Phase A)")
    print("=" * 70)
