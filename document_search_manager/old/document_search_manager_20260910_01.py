...
# -*- coding: utf-8 -*-
"""
Document Search Manager  v20260910_01
=====================================
...
<header>
  ...
  <div class="sub">社内ドキュメント横断検索 &nbsp;/&nbsp; v20260910_01 (フォルダ探索の事前診断)</div>
</header>
...
var SUMMARIZABLE_EXTENSIONS = ["docx", "pptx", "xlsx", "xlsm"];
...
function requestSummary(r, body, overlay, confirmTruncated) {
  ...
  fetch("/api/summarize", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ idx: String(r._idx), confirm_truncated: confirmTruncated }),
  })
    .then(function (resp) {
...
SUMMARIZABLE_EXTENSIONS = ("docx", "pptx", "xlsx", "xlsm")
...
def main() -> None:
    ...
    print("=" * 70)
    print("📚 Document Search Manager  v20260910_01  (フォルダ探索の事前診断)")
    print("=" * 70)
