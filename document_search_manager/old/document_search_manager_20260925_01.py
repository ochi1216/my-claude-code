...
# -*- coding: utf-8 -*-
"""
Document Search Manager  v20260925_01
=====================================
...
【本バージョン(実機バグ修正: netstat等のデコード失敗)のスコープ】
...
<header>
  ...
  <div class="sub">社内ドキュメント横断検索 &nbsp;/&nbsp; v20260925_01 (netstat文字化けクラッシュ修正)</div>
</header>
...
def main() -> None:
    ...
    print("=" * 70)
    print("📚 Document Search Manager  v20260925_01  (netstat文字化けクラッシュ修正)")
    print("=" * 70)
