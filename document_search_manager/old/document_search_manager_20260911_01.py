...
# -*- coding: utf-8 -*-
"""
Document Search Manager  v20260911_01
=====================================
...
<header>
  ...
  <div class="sub">社内ドキュメント横断検索 &nbsp;/&nbsp; v20260911_01 (Enoviaログインの修正)</div>
</header>
...
def main() -> None:
    ...
    print("=" * 70)
    print("📚 Document Search Manager  v20260911_01  (Enoviaログインの修正)")
    print("=" * 70)
