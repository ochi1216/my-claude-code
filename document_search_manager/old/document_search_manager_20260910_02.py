...
# -*- coding: utf-8 -*-
"""
Document Search Manager  v20260910_02
=====================================
...
<header>
  ...
  <div class="sub">社内ドキュメント横断検索 &nbsp;/&nbsp; v20260910_02 (フォルダ探索 Phase A/B)</div>
</header>
...
function openSummaryPopup(r) {
  ...
  requestSummary(r, body, overlay, false);
}

function requestSummary(r, body, overlay, confirmTruncated) {
  body.innerHTML = "";
    ...
    .then(function (result) {
      ...
      if (result.data.needs_confirmation) {
        renderTruncationConfirm(body, result.data, function () {
          requestSummary(r, body, overlay, true);
        });
        return;
      }
...
def main() -> None:
    ...
    print("=" * 70)
    print("📚 Document Search Manager  v20260910_02  (フォルダ探索 Phase A/B)")
    print("=" * 70)
