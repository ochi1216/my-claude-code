...
# -*- coding: utf-8 -*-
"""
Document Search Manager  v20260903_11
=====================================
...
NEXUS_FIELD_CANDIDATES = {
    ...
    "title":             ["qmDocumentTitle", "Document Title", "DocumentTitle",
                          "Title"],
    # Doc Author / Doc Owner に対応する内部名は**未確定**。
    # 人物列は Graph が <名前>LookupId（数値ID）でしか返さないため、
    # 数値しか得られない候補は採用しない（_pick_nexus_fields を参照）。
    "doc_author":        ["qmEditor", "nxDocReviewer", "Doc Author", "DocAuthor",
                          "qmEditorLookupId", "AuthorLookupId"],
    "doc_owner":         ["qmApprover", "qmOwner", "Doc Owner", "DocOwner",
                          "qmConfirmerLookupId"],
...
<header>
  ...
  <div class="sub">社内ドキュメント横断検索 &nbsp;/&nbsp; v20260903_11 (Phase 2.5: タブ構成 + Nexus Index)</div>
</header>
...
def main() -> None:
    ...
    print("=" * 70)
    print("📚 Document Search Manager  v20260903_11  (Phase 2.5: タブ構成 + Nexus Index)")
    print("=" * 70)
