...
# -*- coding: utf-8 -*-
"""
Document Search Manager  v20260904_04
=====================================
...
<header>
  ...
  <div class="sub">社内ドキュメント横断検索 &nbsp;/&nbsp; v20260904_04 (要約機能 Phase A: Executive Summary改善)</div>
</header>
...
def main() -> None:
    ...
    print("=" * 70)
    print("📚 Document Search Manager  v20260904_04  (要約機能 Phase A: Executive Summary改善)")
    print("=" * 70)
