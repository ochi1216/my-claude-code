...
# -*- coding: utf-8 -*-
"""
Document Search Manager  v20260904_06
=====================================
...
<header>
  ...
  <div class="sub">社内ドキュメント横断検索 &nbsp;/&nbsp; v20260904_06 (要約機能 Phase C: .xlsx対応/切り詰め確認)</div>
</header>
...
var SUMMARIZABLE_EXTENSIONS = ["docx", "pptx", "xlsx"];
...
# ここに1行足すだけでよい（Phase B: pptx、Phase C: xlsxを追加。pdfは未対応）。
SUMMARIZABLE_EXTENSIONS = ("docx", "pptx", "xlsx")
...
def _extract_xlsx_text(content: bytes, max_chars: int) -> "tuple[str, bool, int]":
    """xlsxのバイト列から本文テキストを抽出する。(本文, 切り詰めたか, 切り詰め前の文字数) を返す。
...
def main() -> None:
    ...
    print("=" * 70)
    print("📚 Document Search Manager  v20260904_06  (要約機能 Phase C: .xlsx対応/切り詰め確認)")
    print("=" * 70)
