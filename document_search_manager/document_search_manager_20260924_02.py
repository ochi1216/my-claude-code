...
# -*- coding: utf-8 -*-
"""
Document Search Manager  v20260924_02
=====================================
...
【本バージョン(S05 Phase3-0: サイト絞り込み診断)のスコープ】
...
<header>
  ...
  <div class="sub">社内ドキュメント横断検索 &nbsp;/&nbsp; v20260924_02 (サイト絞り込み診断)</div>
</header>
...
def main() -> None:
    ...
    print("=" * 70)
    print("📚 Document Search Manager  v20260911_02  (ログイン失敗の切り分け)")
    print("=" * 70)
