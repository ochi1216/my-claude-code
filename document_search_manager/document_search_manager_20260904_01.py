...
# -*- coding: utf-8 -*-
"""
Document Search Manager  v20260904_01
=====================================
社内のドキュメント管理システムを、同一キーワードで横断検索するツール。
  ...
  3. Enovia     … 3DEXPERIENCE/ENOVIA（本バージョンで実装）
...
<header>
  ...
  <div class="sub">社内ドキュメント横断検索 &nbsp;/&nbsp; v20260904_01 (Phase 3: Enovia検索)</div>
</header>
...
def main() -> None:
    ...
    print("=" * 70)
    print("📚 Document Search Manager  v20260904_01  (Phase 3: Enovia検索)")
    print("=" * 70)
