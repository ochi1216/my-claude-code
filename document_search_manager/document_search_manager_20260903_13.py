...
# -*- coding: utf-8 -*-
"""
Document Search Manager  v20260903_13
=====================================
...
<header>
  ...
  <div class="sub">社内ドキュメント横断検索 &nbsp;/&nbsp; v20260903_13 (Phase 2.5: タブ構成 + Nexus Index)</div>
</header>
...
def main() -> None:
    ...
    print("=" * 70)
    print("📚 Document Search Manager  v20260903_13  (Phase 2.5: タブ構成 + Nexus Index)")
    print("=" * 70)
