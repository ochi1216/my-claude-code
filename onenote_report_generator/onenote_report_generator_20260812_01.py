...
_LANG_VARIANTS = {
    "translate_ja": {
        ...
        "summary_hint": "全体の進捗を300文字以内の自然な日本語で総括。箇条書き不可",
    ...
    "keep_original": {
        ...
        "summary_hint": "全体の進捗を300文字以内で、原文の言語のまま自然に総括。箇条書き不可",
...
{{
  ...
  "updates": {{
    "[{v["category_label"]}]": ["string (更新内容1)", "string (更新内容2)"]
  }},
  "details": {{
    "[{v["category_label"]}]": {{
      "[{v["item_label"]}]": "string (詳細内容)"
    }}
  }},
  "pending_actions": [
    {{
...
if __name__ == "__main__":
    print("OneNote Report Generator 20260812_01 を起動します...")
