...
# -*- coding: utf-8 -*-
"""
tool_launcher_20260915_02.py  --  my-claude-code ツールランチャー v2
...
def _pid_has_visible_window(pid):
    """指定PIDが所有する、目に見える(可視状態の)トップレベルウィンドウが
    1つでもあるかを調べる。メインウィンドウに限らず、確認ダイアログのような
