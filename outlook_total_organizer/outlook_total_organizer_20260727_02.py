    ...
    def generate_action_dashboard_report(self, action_cards, date_range, total_input, total_output, reformat_mode=False) -> str:
        ...
        try:
            ...
            for card in sorted_cards:
                ...
                # 内側(.card-inner)=重要度バー(4px)。ヘッダー行にカテゴリ/R19Projマーク/タイトルをまとめ、
                # フラグ・受信日時・進捗/優先度ボタンは各.action-itemの先頭行(topline)に移動した。
                cards_html.append(f'''
            ...
            <head>
                ...
                .action-item-topline {{ display:flex; align-items:center; gap:8px; flex-wrap:wrap; }}
                ...
                .action-item-detail-row {{ display:flex; align-items:flex-start; gap:8px; }}
