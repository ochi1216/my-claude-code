...
def load_project_knowledge():
    default_knowledge = {
        ...
        "projects": {
            "00_Caracal": {"history_summary": "", "human_answers": ""},
            "01_Wheeling": {"history_summary": "", "human_answers": ""},
            "02_GrandTeton": {"history_summary": "", "human_answers": ""},
            "03_R19Projects": {"history_summary": "", "human_answers": ""}
        }
    }
...
class OutlookMailManager:
    ...
    def _item_to_dict(self, item, received_dt, folder_name, light_mode=False, skip_attachments=False):
        ...
        category_tokens = [
            c.strip().upper()
            for c in re.split(r'[;,]\s*', categories)
            if c and c.strip()
        ]
        has_just_do_it_category = "JUST DO IT" in category_tokens
    ...
    def get_project_mails(self, folder_name: str, days: int) -> list:
        """
...
class MailSummarizer:
    ...
    def summarize_action_dashboard(self, threads: dict, progress_callback=None) -> dict:
        """
...
<div class="nav-fab-container">
    ...
    def generate_action_dashboard_report(self, action_cards, date_range, total_input, total_output, reformat_mode=False) -> str:
        ...
        try:
                ...
                <div class="sticky-top">
                    ...
                    <div class="controls">
                        ...
                        <div class="filter-group">
                            ...
                            <button class="filter-btn" id="r19FilterBtn" onclick="toggleR19Filter(this)">🧩 R19Proj</button>
                        </div>
                        <div class="filter-group">
            ...
            let r19FilterActive = false;
            function toggleR19Filter(btn) {{
                r19FilterActive = !r19FilterActive;
                btn.classList.toggle('active', r19FilterActive);
                applyActionFilters();
            }}
            function applyActionFilters() {{
                ...
                allCards.forEach(card => {{
                    const r19Match = !r19FilterActive || card.dataset.r19 === 'true';
...
class MailManagerGUI:
    ...
    def _get_action_days(self):
        return {"24H": 0, "今日": 1, "3日間": 3, "1週間": 7, "2週間": 14}.get(self.v_action_prd.get(), 7)
    ...
    def _open_knowledge_editor(self):
        ...
        for proj in ["00_Caracal", "01_Wheeling", "02_GrandTeton"]:
            ...
            ttk.Button(ptab, text=f"このプロジェクト({proj})を保存", command=lambda p=proj, m=t_m, a=t_a: self._save_proj_kn(p, m.get("1.0", tk.END), a.get("1.0", tk.END))).pack(pady=10)
    ...
    def _save_proj_kn(self, proj, master, ai_hist):
