"""pdf_translator_20260911_01.py の Gemini プロキシ移行部分の検証テスト。
...
実行方法:
    pip install PyMuPDF
    python3 tests/test_pdf_translator_20260911_01.py
"""
...
check("日本語出力(japan指定)は文字単位描画に切り替わらない",
      mod._needs_mixed_fonts("日本語の見出し", "japan") is False)
