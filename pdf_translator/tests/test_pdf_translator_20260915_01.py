"""pdf_translator_20260915_01.py の Gemini プロキシ移行部分の検証テスト。
...
実行方法:
    pip install PyMuPDF
    python3 tests/test_pdf_translator_20260915_01.py
"""
...
if _RESUME_SRC_CANDIDATES:
    ...
    check("元が複数の箇条書きを含むブロックが存在する（検証の前提）", len(_bulleted) >= 2,
