# -*- coding: utf-8 -*-
"""RTOCS 統合マネジメントダッシュボード v20260715_08
...
起動: streamlit run rtocs_dashboard_20260715_08.py

v08での変更点（strategy_engine.py / strategy_prompts.py / strategy_report.pyの更新に対応）:
  - 株式市場分析ステージで、手元資金(total_cash)・総負債(total_debt)・負債資本比率・
    フリーキャッシュフローをyfinanceから追加取得し、「M&Aや大規模投資に振り向けられる
    資金余力」の所見を戦略提言に反映するための材料とした
  - レポートの株式市場分析カードに、財務実行可能性データの表と「資金余力」所見を追加
