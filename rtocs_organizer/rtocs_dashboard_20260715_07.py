# -*- coding: utf-8 -*-
"""RTOCS 統合マネジメントダッシュボード v20260715_07
...
起動: streamlit run rtocs_dashboard_20260715_07.py

v07での変更点（strategy_engine.py / strategy_prompts.py / strategy_report.pyの更新に対応）:
  - 戦略分析タブに「経営の制約条件（任意）」入力欄を追加。負債covenant・取締会の性質等、
    AIには分からない経営者自身の制約を入力すると、課題分析・戦略策定の全ステージ
    （ディープモードの批判・改訂パス含む）で必須順守として反映される
