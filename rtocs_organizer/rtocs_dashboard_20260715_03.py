# -*- coding: utf-8 -*-
"""RTOCS 統合マネジメントダッシュボード v20260715_03
...
起動: streamlit run rtocs_dashboard_20260715_03.py

v03での変更点（strategy_engine.py / strategy_prompts.py / strategy_report.pyの更新に対応）:
  - 課題分析カードの「根拠」を配列表示に変更し、1項目ずつ改行して見やすくした
  - 直近ニュース収集ステージを追加（Google Search Groundingで英語・日本語・中国語の
    企業名表記に対応し、直近12ヶ月のニュースを検索。会社分析の直後の新規ステージ）
"""
