# -*- coding: utf-8 -*-
"""RTOCS 統合マネジメントダッシュボード v20260715_02
...
起動: streamlit run rtocs_dashboard_20260715_02.py

v02での変更点:
  - キーワードトレンド線タブでの NameError (kw未定義) を修正
  - Streamlitの use_container_width 非推奨引数を width='stretch' に置換
"""
