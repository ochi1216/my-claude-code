# -*- coding: utf-8 -*-
"""RTOCS 統合マネジメントダッシュボード v20260715_11
...
起動: streamlit run rtocs_dashboard_20260715_11.py

v11での変更点:
  - 戦略分析タブに、レポート生成後の「深掘りチャット」機能を追加。生成済みの全分析結果を
    文脈として、経営者からの追加質問にAIが自然文（非JSON）で回答する。1問1回のGemini呼び出し
    （strategy_engine.answer_followup_question）で、追加コストを都度表示する
